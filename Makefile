...
LIBHDR = cudamem.hh random.hh tron.hh ppm.hh layout.hh megatron.hh wiring.hh persist.hh dataset.hh topology.hh multitron.hh project.hh twiddle.hh sampler.hh closest.hh pipeline.hh parson.hh ipdb.hh warp.hh vocab.hh confab.hh script.hh strutils.hh hashbag.hh shibboleth.hh brane.hh rule.hh wildmap.hh stage.hh zone.hh bus.hh numutils.hh server.hh commands.hh
